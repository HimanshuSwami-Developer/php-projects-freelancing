...
text/x-generic door-supervision-first-aid-training.php ( PHP script, UTF-8 Unicode text, with very long lines )
<?php
session_start();
        ...
        <div class="bg-[#f8f8f8] py-10 min-h-screen">
            ...
            <div class="container mx-auto p-4 sm:p-6 max-w-[1280px]">
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-bold text-black">
                        ...
                        <span class="text-[#00C1EC]">DOOR SUPERVISION AND FIRST AID TRAINING</span>
                    </h1>
                    ...
                    <div
                        ...
                        <div class="w-full md:w-[70%] order-2 md:order-1">
                            ...
                            <h2 class="text-2xl sm:text-3xl font-extrabold text-black mb-4 border-b-2 border-gray-100 pb-2">
                                Door Supervision Course Details
                            </h2>
                            ...
                            <div class="space-y-3 text-sm sm:text-base grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3">
                                ...
                                <p class="text-gray-700">
                                    ...
                                    <span class="text-lg font-semibold text-[#00C1EC]">Door Supervision and First Aid Training</span>
                                </p>
                                ...
                                <p class="text-gray-700 col-span-1 sm:col-span-2">
                                    ...
                                    <span class="text-lg font-semibold">Full Door Supervision Qualification + Emergency First Aid Training</span>
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <div class="mb-4 sm:mb-0">
                                    ...
                                    <p class="text-4xl font-extrabold text-green-600">
                                        <!-- Price preserved from LIVE code -->
                                        £350 <span class="text-xl font-normal text-gray-500">Incl. VAT</span>
                                    </p>
                                </div>
                        ...
                        <div class="w-full md:w-[25%] flex justify-center items-center order-1 md:order-2 mb-6 md:mb-0">
                            ...
                            <img src="https://res.cloudinary.com/dgalk9xcx/image/upload/v1760267999/2_cdhxwc.png"
            ...
            <div class="max-w-[1280px] mx-auto px-4 sm:px-6 pb-10">
                ...
                <div id="tab-3" class="tab-content bg-white">
                    <h3 class="content-subtitle-new">What Qualification do i need to be a Door Supervisior?</h3>
