...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <div class="bg-white p-10 rounded-2xl shadow-xl text-center">
    ...
    <p class="text-gray-600 mb-4">Unfortunately, your payment could not be completed. Please try again.</p>
    <a href="/" class="inline-block mt-4 px-6 py-2 bg-red-600 text-white rounded hover:bg-red-700">Go Back</a>
  </div>
