        ...
        <div class="bg-[#f8f8f8]">
            ...
            <div class="full-width-slider-section bg-white">
                <div class="lg:w-[1280px] mx-auto px-4">
                    <h2 class="text-4xl font-bold text-center text-[#00C1EC] mb-2">Get your SIA license <span
                            class="text-black">to work in security</span></h2>
            ...
            <div class="text-center my-10 max-w-4xl mx-auto">
                <h2 class="text-4xl font-bold text-center text-[#00C1EC] mb-2 ">Here’s how it usually works for most of
                    our learners.</h2>
                <p class="md:text-lg text-[13px]  mb-2  lg:mx-0 mx-auto text-black mt-5">
                    First, you complete your training. Depending on the course you choose, this takes <b>between 3 and 7
                        days</b>. During this time, you’ll build the core skills needed to work safely, confidently, and
                    legally in security roles.
                </p>
                <p class="md:text-lg text-[13px]  mb-2  lg:mx-0 mx-auto text-black">
                    Next, you pass a short exam and receive your training certificate. After that, you apply for your
                    SIA licence. This part typically takes <b>7–10 days</b>.
                </p>
                <p class="md:text-lg text-[13px]  mb-2  lg:mx-0 mx-auto text-black">
                    Once your licence is approved, you can start applying for jobs straight away. Many of our learners
                    go on to earn <b>£14 to £25 per hour</b>, with monthly earnings of up to <b>£3,000</b>, depending on
                    the role and hours you choose to work.
                </p>
            </div>
            ...
            <section class="py-16 md:py-24 border-t border-gray-200 bg-white">
                <div class="lg:w-[1280px] mx-auto px-4">
                    ...
                    <p class="md:text-lg text-[13px]  mb-2  lg:mx-0 mx-auto text-black text-center">
                        All of our courses are fully approved by the <b>Security Industry Authority (SIA)</b> and
                        designed to be beginner-friendly. Even if you’re completely new to security, the training is
                        structured for you to follow along comfortably.
                    </p>
                                            ...
                                            <div>
                                                ...
                                                <?php if ($isDoorSupervision): ?>
                                                    <div class="flex flex-col gap-1 mb-4">
                                                        <span
                                                            class="text-gray-500 text-sm line-through">£<?php echo $row['regular_price']; ?></span>
                                                        <span class="text-2xl font-extrabold text-[#00C1EC]">
                                                            £<?php echo $row['sale_price']; ?>
                                                            <span
                                                                class="text-xs font-semibold text-gray-600">(<?php echo $discount; ?>%
                                                                off)</span>
                                                        </span>
                                                    </div>
                                                <?php else: ?>
                                                ...
                                                <div class="flex items-center justify-between space-x-2">
                                                    ...
                                                    <form method="post" class="space-y-4 sharedForm">
                                                        ...
                                                        <input type="hidden" name="course_p"
                                        ...
                                        <div>
                                            ...
                                            <?php if ($isDoorSupervision): ?>
                                                <div class="flex flex-col gap-1 mb-6 mt-4">
                                                    <span
                                                        class="text-gray-500 text-base line-through">£<?php echo $row['regular_price']; ?></span>
                                                    <span class="text-3xl font-extrabold text-[#00C1EC]">
                                                        £<?php echo $row['sale_price']; ?>
                                                        <span class="text-sm font-semibold text-gray-600">(<?php echo $discount; ?>%
                                                            off)</span>
                                                    </span>
                                                </div>
                                            <?php else: ?>
                                            ...
                                            <div class="flex items-center justify-between space-x-2">
                                                <a href="<?php echo $row['info_link']; ?>"
                                                    class="text-[#00C1EC] font-semibold hover:underline transition-colors">More
                                                    Info</a>
                                                <form method="post" class="space-y-4 sharedForm">
                                                    <input type="hidden" name="course_name"
                                                        value="<?php echo htmlspecialchars($row['title']); ?>">
            ...
            <div class=" my-10 max-w-4xl mx-auto">
                <h2 class="text-4xl font-bold text-center text-[#00C1EC] mb-2 ">SIA licenses <span
                        class="text-black">you can apply post-training</span></h2>
                <div class=" my-5 md:max-w-2xl mx-auto mx-6">
                    <p class="md:text-lg text-[13px]  mb-2  lg:mx-0 mx-auto text-black mt-5">
                        After completing your training, you’ll be eligible to apply for an official SIA licence, which
                        is a mandatory requirement to work legally in the UK security industry.
                    </p>
                    ...
                    <p class="md:text-lg text-[13px]  mb-2  mx-auto text-black">
                        These licences are recognised nationwide and reputable employers check if you have one before
                        hiring you for a particular role.
                    </p>
                </div>
            </div>
            ...
            <div class="py-16 md:py-24 bg-[#f8f8f8]">
                <div class="lg:w-[1280px] mx-auto px-4">
                    ...
                    <p class="text-xl text-center text-[#000] mb-8">Our trainers have <b>over three decades of combined
                            experience</b> in frontline security and professional training. They’ve done the job
                        themselves, so they understand what employers look for and how to prepare you properly. You
                        won’t just learn how to pass an exam, you’ll learn how to work confidently once you’re licensed!
                        Meet out team.</p>
                ...
                <div class="lg:w-[1280px] mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="p-5 text-white">
                                ...
                                <p class="text-gray-300 text-sm leading-relaxed">
                                    With over 10 years of front-line security experience, Luzuko brings hands-on
                                    expertise to the classroom. Based in Manchester and Dynamisis PI certified, his
                                    <b>conflict management classes</b> are a must-attend for any aspiring professional.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="p-5 text-white">
                                ...
                                <p class="text-gray-300 text-sm leading-relaxed">
                                    A versatile Manchester-based trainer and Dynamisis PI license holder. Muhammad
                    ...
                    <div class="text-white lg:text-left text-center">
                        ...
                        <p class="text-xl text-gray-400 mb-8 leading-relaxed">
                            Our trainers have over three decades of combined experience in frontline security and
                            professional training. They’ve done the job themselves, so they understand what employers
                            look for and how to prepare you properly. You won’t just learn how to pass an exam, you’ll
                            learn how to work confidently once you’re licensed!
                        </p>
            ...
            <div class="py-16 md:py-24 bg-white">
                <div class="lg:w-[1280px] mx-auto px-4">
                    ...
                    <div class="flex flex-wrap items-center gap-4 mb-10">
                        ...
                        <p class="text-gray-600">We’re proud to be rated 5/5 on Google Reviews by over 120+ learners.
                        </p>
                    </div>
                    ...
                    <div class="swiper mySwiper pb-12">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide h-auto">
                                <div
                                    class="bg-gray-50 p-6 rounded-xl shadow-lg border-t-4 border-[#00C1EC] h-full flex flex-col">
                                    <div class="flex items-start mb-4">
                                        <div
                                            class="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                    ...
                                    <div>
                                        <p class="text-gray-700 text-sm leading-relaxed italic">
                                            "I just completed a door supervisor training, and it was really informative.
                                            The course covered essential skills like conflict resolution and effective
                                            communication, which are crucial for the role. I particularly enjoyed the
                                            practical scenarios we worked through, as they helped me understand how to
                                            handle real-life situations. Overall, it was a valuable experience that has
                                            prepared me well for my responsibilities as a door supervisor."
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide h-auto">
                                <div
                                    ...
                                    <div class="flex items-start mb-4">
                                        <div
                                            class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                    ...
                                    <div>
                                        <p class="text-gray-700 text-sm leading-relaxed italic">
                                            "I had a positive experience. The staff were friendly and supportive, and
                                            the teaching methods were effective in helping me understand the material.
                                            The course was well-structured, and I appreciated the opportunities to ask
                                            questions and engage with the instructors."
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide h-auto">
                                <div
                                    ...
                                    <div class="flex items-start mb-4">
                                        <div
                                            class="w-12 h-12 bg-teal-600 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                                    ...
                                    <div>
                                        <p class="text-gray-700 text-sm leading-relaxed italic">
                                            "I had a great experience with G Security and Training Center. The tutor
                                            taught clearly and gave strong focus to practical training, which really
                                            helped my learning. The classroom environment was supportive, and the course
                                            covered all key areas of door supervision. I am very satisfied and would
                                            recommend this center to friends and family."
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="w-full p-4 lg:p-0 order-2 lg:order-1">
                        ...
                        <div class="space-y-4">
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                <button
                                    class="w-full text-left p-4 bg-white text-gray-900 focus:outline-none flex justify-between items-center transition-all hover:bg-gray-50"
                                ...
                                <div id="faq-home-1" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">G-Security and Training’s Door Supervision
                                        course is a sure-fire way you can gain the necessary skills that help you
                                        legally qualify and obtain an SIA license for working in security roles.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-2" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">Luckily, you don’t. We’ve trained thousands
                                        of freshers who had zero experience in the industry, who are now earning to
                                        their highest potential in security.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-3" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">The actual training part only takes 3-7
                                        days. The entire process, including exams and license application, usually takes
                                        about three weeks.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-4" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">The Door Supervision course costs £350. It’s
                                        a great investment that often pays for itself in nearly 10 days once you start
                                        working.</p>
                                </div>
                            </div>
                                    ...
                                    <div class="p-4 border-t border-gray-200">
                                        ...
                                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Door
                                                Supervisor / Bouncer</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Event
                                                Security / Steward</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Corporate
                                                Security Officer</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Retail
                                                Security Guard</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Construction
                                                Site Security</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Concierge /
                                                Reception</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Mobile Patrol
                                                Officer</li>
                                            <li class="flex items-center"><span
                                                    class="w-2 h-2 bg-[#00C1EC] rounded-full mr-2"></span> Keyholding
                                                Services</li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-6" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">Yes! This training allows you to apply for
                                        an SIA license, which is the legal requirement and the most common qualification
                                        requested by UK security employers.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-7" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">Don't worry—mishaps happen. We offer plans
                                        with multiple free resits and provide expert guidance to ensure you pass
                                        comfortably on your next attempt.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-8" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">Free first aid training is included in our
                                        Gold and Diamond plans, as well as our Top-Up courses, giving you an extra edge
                                        with employers.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-9" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">This is for existing license holders who
                                        need to renew their 3-year license. It covers new industry standards and skills
                                        developed since your last training.</p>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                ...
                                <div id="faq-home-10" class="collapsess hidden bg-gray-50 text-gray-700">
                                    <p class="p-4 border-t border-gray-200">Once you pass and apply for your SIA license
                                        (which takes 7-10 days to approve), you can start working immediately. Usually,
                                        you're earning within 3-4 weeks.</p>
                                </div>
                            </div>
                    ...
                    <div class="w-full p-4 lg:p-0 text-center lg:order-2">
                        ...
                        <div class="mt-12 py-10 px-6 bg-white rounded-xl border-2 border-dashed border-gray-200">
                            ...
                            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                                If you’re ready to get started, the next step is simple. <a href="/courses"
                                    class="text-blue-600">Choose the course</a> that suits you, book your place, and
                                we’ll guide you through the rest.
                                <br>
                                With <b>G Security & Training</b>, you get <b>SIA security training courses in Leeds and
                                    Bradford</b> that prepare you for real work. For more doubts, feel free to contact
                                us anytime.
                            </p>
                            <!--<div class="flex flex-col sm:flex-row gap-4 justify-center">-->
                            <!--    <a href="/courses" -->
